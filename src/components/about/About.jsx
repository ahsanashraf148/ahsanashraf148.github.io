  ...
  return (
    <section id='about'>
      ...
      <div className="container about__container">
        ...
        <p>Hello!<br />I am Ahsan Ashraf, pursuing my undergraduate studies from the National University of Computer and Emerging Science (FAST-NUCES) in the field of Computer Science. I am an inquisitive and enthusiastic developer with leadership skills and a strong foundation in mathematics, logic, problem-solving, and coding. In addition to it, I am learning and practicing computer science streams like Data Engineering, Data Science, Machine Learning, and Deep Learning, and that's what I am passionate about.</p>
